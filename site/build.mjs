...
const REPO = 'https://github.com/Allan-Nava/trimhook'
const BLOB = `${REPO}/blob/main`
const SITE = 'https://allan-nava.github.io/trimhook/'
  ...
  return cards
    .map(
      (c) => `      <article class="card">
        ...
        <p>${esc(c.status.replace(/^trimhook:\s*/, ''))}</p>
        <ul class="refs">
          <li><a href="${BLOB}/bin/trimhook.mjs"><code>trimhook ${esc(c.handler)}</code></a></li>
...
const inventorySection = `  <section id="the-hooks">
    <h2><a class="anchor" href="#the-hooks">The hook, from hooks.json</a></h2>
    <p>Straight from <code>hooks/hooks.json</code>. One handler, one file, a hard timeout; it falls through whenever it cannot trim.</p>
    <div class="cards">
${renderInventory()}
    </div>
  </section>`
...
<meta name="theme-color" content="#2f7d5a" media="(prefers-color-scheme: light)">
...
:root {
  ...
  --accent: #2f7d5a; --accent-soft: #e6f3ec; --code-bg: #f4f1ec;
...
@media (prefers-color-scheme: dark) {
  :root {
    ...
    --accent: #7fd0a6; --accent-soft: #14231b; --code-bg: #1c1a17;
  }
}
...
<footer>
  <div class="wrap row">
    <span>MIT · <a href="${REPO}">Allan-Nava/trimhook</a></span>
...
// what gets trimhook listed there; a robots.txt at /trimhook/ would be dead weight.
